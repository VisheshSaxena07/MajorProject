            ...
            <div class="form login">
                ...
                <form action="#" method="post">
                    ...
                    <div class="input-field button">
                        <input type="button" value="Login" name="Submit_btn" id="submit" onclick="window.location.replace('admin');" disabled>
                    </div>
                    <div class="contentforg">
                        <a href="forgotWay.php" class="txt" target="_self">Forgot Password or Id?</a>
                    </div>
                </form>
            </div>
        </div>
