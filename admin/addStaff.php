                    ...
                    <div class="h-auto w-auto p-1">
                        <div class="form-row">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label inputfeild" for="AdharCard">Choose Passport Size Photo</label>
                            </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="h-auto w-auto infobox"> 
                    ...
                    <div class="h-auto w-auto p-1">
                        ...
                        <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="tenschoolname">Work Type</label>
                                    <input type="text" class="form-control inputfeild" name="tenschoolname" id="tenschoolname" placeholder="Type of work">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="tenschoolname">Working Department</label>
                                    <input type="text" class="form-control inputfeild" name="tenschoolname" id="tenschoolname" placeholder="Working at which place in institute">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="tenschoolname">Working Institute</label>
                                    <input type="text" class="form-control inputfeild" name="workingInstitue" id="workingInstitute" placeholder="Working at which place in institute">
                                </div>
