    ...
    <section class="homePage">
        <div class="homePage-base">
            ...
            <div class="head">
                <div class="head-1">
                    <div class="head-text">
                        <div class="pannel-heading"> View Result</div>
                    </div>
                    <div class="Profile">
                        <div class="pro-1">
            ...
            <div class='main'> 
                ...
                <div class="s1_1" id="sec2">
                    <div class="s1_2">
                        ...
                        <div class="filters">
                            <div class="inputbase"> 
                                <input type="text" name="staffname" placeholder="Student ID"> 
                                <input type="button" name="view _result" id="view_result" value="View Result" onclick="window.location.replace('viewResultdisplay.php')">
                            </div>
                            <hr>
                        </div>
