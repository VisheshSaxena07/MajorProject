...
<head>
    ...
    <link rel="stylesheet" href="./css/backpaper.css">
    ...
    <title>Student | Exam | Back Paper</title>
</head>
    ...
    <section class="homePage">
        <div class="homePage-base">
            ...
            <div class="head">
                <div class="head-1">
                    <div class="head-text">
                        <div class="pannel-heading"> Eaxm </div>
                    </div>
                    <div class="Profile">
                        <div class="pro-1">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <div class="data">  <input type="checkbox" name="select_back" id="select_back"> </div> </td>
                                            <td> <div class="data"> <input type="text" name="sub_name" id="sub_name" value="Data Analysis Algorithm" readonly> </div> </td>
                                            <td> <div class="data"> <input type="text" name="sub_code" id="sub_code" value="TCS-402" readonly> </div> </td>
                                            <td> <div class="data"> <input type="text" name="sub_year" id="sub_year" value="4" readonly> </div> </td>
                                            <td> <div class="data"> <input type="text" name="sub_year_sem" id="sub_year_sem" value="2" readonly> </div> </td>
                                            
                                        </tr>
                                    </tbody>
                                </table>
                                <div class="btn-div">
                                    <input type="submit" name="applyback" id="applyback" value="Apply">
                                </div>
                            </form>
                        </div>
