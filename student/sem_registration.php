...
<head>
    ...
    <title>Acadmics | Semester Registration</title>
</head>
...
<!-- Side Nav Bar -->
    ...
    <section class="homePage">
        <div class="homePage-base">
            ...
            <!-- bread crums -->
            <div class="ss-head" id="ss-head">
                <div class="ss-inner-base">
                    <h3>Acadmics | Semester Registration</h3>
                </div>
            </div>
                    ...
                    <!-- PERSONAL INFO BOX -->
                        <div  class="personal-info">
                            ...
                            <div class="prebody">
                                ...
                                <div class="img-base">
                                     <img src="./images/male.jpg" alt="no img" srcset=""> 
                                </div>
                                ...
                                <div class="details">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td><div class="title">Student Name :</div></td>
                                                <td><div class="content">VISHESH SAXENA</div></td>

                                                <td><div class="title">Father's Name :</div></td>
                                                <td><div class="content">VIVEK SAXENA</div></td>

                                                <td><div class="title">Mother's Name :</div></td>
                                                <td><div class="content">EESHA SAXENA</div></td>

                                                
                                            </tr>
                                            <tr>
                                                <td><div class="title">Gender :</div></td>
                                                <td><div class="content">Male</div></td>

                                                <td><div class="title">Category :</div></td>
                                                <td><div class="content">General</div></td>

                                                <td><div class="title">DOB :</div></td>
                                                <td><div class="content">10/01/2002</div></td>
                                            </tr>
                                            <tr>
                                                <td><div class="title">Blood Group:</div></td>
                                                <td><div class="content">A+ve</div></td>

                                                <td><div class="title">Mobile No. :</div></td>
                                                <td><div class="content">7355288989</div></td>

                                                <td><div class="title">Email-ID :</div></td>
                                                <td><div class="content">visheshsaxena7777@gmail.com</div></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="prebody">
                                ...
                                <div class="details">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td><div class="title">College Name :</div></td>
                                                <td><div class="content">GEU</div></td>

                                                <td><div class="title">Course :</div></td>
                                                <td><div class="content">BACHELOR OF TECNOLOGY</div></td>

                                                <td><div class="title">Year Sem :</div></td>
                                                <td><div class="content">8</div></td>

                                                
                                            </tr>
                                            <tr>
                                                <td><div class="title">Branch :</div></td>
                                                <td><div class="content">(CSE) with S/W Eng</div></td>

                                                <td><div class="title">Section :</div></td>
                                                <td><div class="content">SE</div></td>

                                                <td><div class="title">Roll No :</div></td>
                                                <td><div class="content">2015116</div></td>
                                            </tr>
                                            <tr>
                                                <td><div class="title">-</div></td>
                                                <td><div class="content">-</div></td>

                                                <td><div class="title">EnrollNo : :</div></td>
                                                <td><div class="content">GE-19021404</div></td>
                        ...
                        <div class="buttonbase">
                            <input type="button" name="SemRegister" id="SemRegister" value="Apply">
                        </div>
